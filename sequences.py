...
# basically the problem is that when recombining oligo fragments, there are some sequences that are new and not in the original ones made from chimeras.py (i think)
# num of unique sequences made from oligos is double that from the sequences list

# SOLUTION: make function that takes the final oligo sequence made from the 3 fragments and check to see if 
# it is in the sequences list from generate_fragments()
